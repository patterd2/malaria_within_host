...
for i = 1:length(c_values)
    ...
    hold on;
    if i == 1
        plot(x(1:length_infection_out)/24,E_merozoites(1:length_infection_out),...
            '-','Color',[0 0 0],'LineWidth',3);
    elseif i == 2
        plot(x(1:length_infection_out)/24,E_merozoites(1:length_infection_out),...
        '-','Color',[91/256 149/256 194/256],'LineWidth',3);
    else
        plot(x(1:length_infection_out)/24,E_merozoites(1:length_infection_out),...
        '-','Color',[186/256 218/256 1],'LineWidth',3);
    end
    ...
    hold on;
    if i == 1
        plot(x(1:length_infection_out)/24,P_bursting(1:length_infection_out),...
            '-','Color',[0 0 0],'LineWidth',3);
    elseif i == 2
        plot(x(1:length_infection_out)/24,P_bursting(1:length_infection_out),...
            '-','Color',[91/256 149/256 194/256],'LineWidth',3);
