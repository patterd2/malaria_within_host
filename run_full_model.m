...
P.T = T_max;
h = 0.0025; % time/age since infection, etc. step size in hours;
x = (0:h:T_max)';
nx = length(x);
...
xlabel('Time since infection (days)');
legend('$I(t,0)$','$I(t,0.5)$','$I(t,1)$','$I(t,2)$','$I(t,3)$');
axis tight;
grid on;
...
xlabel('Time since infection (days)');
legend('$I_G(t,0)$','$I_G(t,0.5)$','$I_G(t,1)$','$I_G(t,2)$','$I_G(t,3)$');
axis tight;
grid on;
